...
function App() {
  ...
  const insertUsers = (event) => {
    ...
    axios.post('http://localhost:3001/insert', { userid: userid, emailid: email, password: password })
  ...
  const updateUsers = () => {
    ...
    axios.put('http://localhost:3001/update', { userid: userid, emailid: email , password: password})
